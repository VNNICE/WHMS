...
namespace DBMS
{
    ...
    {
        public static void MakeDefaultData(out string msg)
        {
            try
            {
                ...
                msg = "DBフォルダー: " + DataPath.dbPath;
            }
            catch (Exception ex)
            {
                msg = "DB生成失敗、" + ex.ToString();
            }
        }
        public static void SetACityLists(out string msg)
        {
            using (var context = new DatabaseContext())
            {
                try
